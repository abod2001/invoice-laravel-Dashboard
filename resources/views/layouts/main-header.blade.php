    ...
    <div class="container-fluid">
        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                @can('الاشعارات')
                <div class="dropdown nav-item main-header-notification dropdown-notifications">
                    <a class="new nav-link" href="#">
                        ...
                        </svg><span class=" pulse"></span>{{auth()->user()->unreadNotifications->count()}}</a>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{URL::asset('assets/img/faces/18.jpg')}}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/18.jpg')}}"
                                        class=""></div>
