                                    ...
                                    <div class="tab-pane active" id="tab4">
                                        <div class="table-responsive mt-15">
                                            ...
                                            <table class="table table-striped" style="text-align:center">
                                                <tbody>
                                                    @foreach ($invoce['invoices'] as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->sections->section_name }}</td>
                                                    </tr>
                                    ...
                                    <div class="tab-pane" id="tab5">
                                        <div class="table-responsive mt-15">
                                            <table class="table center-aligned-table mb-0 table-hover"
                                                ...
                                                <tbody>
                                                    <?php $i = 0; ?>
                                                    @foreach ($invoce['invoiceDetails'] as $x)
                                                    <?php $i++; ?>
                                                    <tr>
                                                        <td>{{ $i }}</td>
                                        ...
                                        <div class="card card-statistics">
                                            ...
                                            <div class="table-responsive mt-15">
                                                <table class="table center-aligned-table mb-0 table table-hover"
                                                    ...
                                                    <tbody>
                                                        <?php $i = 0; ?>
                                                        @foreach ($invoce['InvoiceAttachment'] as $attachment)
                                                        <?php $i++; ?>
                                                        <tr>
                                                            <td>{{ $i }}</td>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <a class="btn btn-outline-success btn-sm"
                                                                    href="{{ url('view_file') }}/{{ $item->invoice_number }}/{{ $attachment->file_name }}"
                                                                    role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                    عرض</a>


                                                                <a class="btn btn-outline-info btn-sm"
                                                                    href="{{ url('download') }}/{{ $item->invoice_number }}/{{ $attachment->file_name }}"
