    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <a href="{{route('invoices.create')}}" class="modal-effect btn btn btn-primary" style="color:white"><i
                        class="fas fa-plus"></i>&nbsp; اضافة فاتورة</a>


                <a class="modal-effect btn btn-primary" href="{{ route('export_invoices') }}" style="color:white"><i
                ...
                <form method="post" enctype="multipart/form-data" action="{{ url('/import_excel/import') }}">
                    ...
                    <div class="form-group">
                        <table class="table">
                            <tr>
                                <td width="40%" align="right"><label>حدد ملف للتحميل</label></td>
                                <td width="30">
